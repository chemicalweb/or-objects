...
public class SingleVertexListenerAdapter implements SingleVertexListenerI {
	public void initialize(GraphI graph, SingleVertexI algorithm) {
	}

	public void beginPathTree(VertexI root, boolean isToRoot) {
	}

	public void updateVertexCost(VertexI from, EdgeI edge, VertexI to, EdgeValueI values) {
	}
