...
public class Algebras {
	...
	SVDecompositionI _SVDecomposition;
	LUDecompositionI _LUDecomposition;
	
	public SVDecompositionI getSVDecomposition() {
		return _SVDecomposition;
	}
	public void setSVDecomposition(SVDecompositionI sVDecomposition) {
		_SVDecomposition = sVDecomposition;
	}
	...
	public void setLUDecomposition(LUDecompositionI lUDecomposition) {
		_LUDecomposition = lUDecomposition;
	}
