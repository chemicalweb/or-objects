...
public class Survivals {
	...
	ProportionalHazardsI proportionalHazards;
	SurvivorFunctionI survivalFunction;

	public ProportionalHazardsI getProportionalHazards() {
		if (proportionalHazards == null)
			proportionalHazards = new CoxModel();
	...
	public SurvivorFunctionI getSurvivorFunction() {
		if (survivalFunction == null)
			survivalFunction = new KaplanMeier();
		return survivalFunction;
	}

	public void setSurvivorFunction(SurvivorFunctionI survivalFunction) {
		this.survivalFunction = survivalFunction;
	}
