...
public class EmpiricalDistribution extends DiscreteDistribution implements EmpiricalDistributionI {
	...
	public EmpiricalDistribution(int[] x, VectorI probability) {
